...
const SampleVal = createContext<string | null>(null);
  ...
  return (
    <SampleStateContext.Provider value={state}>
      <SampleDispatchContext.Provider value={dispatch}>
        <SampleVal.Provider value={"val"}>{children}</SampleVal.Provider>
...
export function useSampleVal() {
  const val = useContext(SampleVal);
  if (!val) throw new Error("Cannot find SampleProvider"); // 유효하지 않을땐 에러를 발생
  return val;
}
